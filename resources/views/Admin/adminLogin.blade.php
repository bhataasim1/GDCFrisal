...
<body class="bg-gray-200">
    <div class="flex flex-col justify-center items-center h-screen">
        ...
        <div class="bg-white p-16 rounded-lg shadow-lg text-center w-96">
            <h3 class="text-3xl text-gray-800 mb-8 font-semibold">Admin Login</h3>
            <form action="{{ route ('admin.login')}}" method="POST">
                @csrf

                <x-Inputs type="text" name="username" label="username" placeholder="Username or Email" />
            ...
            <p class="mt-8"><a href="#" class="text-blue-500 hover:underline"><i
