<div class="py-1 toparea">
    <div class="container mx-auto flex flex-col md:flex-row justify-between items-center md:items-center space-y-3 md:space-y-0 md:space-x-4">
        <div class="flex space-x-1">
            <a href="/" class="font-small flex items-center fa__icons"><i class="fa fa-facebook"></i></a>
            <a href="/" class="font-small flex items-center fa__icons"><i class="fa fa-twitter"></i></a>
        </div>
